...
<%
		'取得當下網址'
		queryS = Request.QueryString("searchType")
		if queryS = "1" then
				...
				SEOUrl = "https://event.1111.com.tw/event22/22yAdmissionSystem/inquire?years=111&searchType=1"
		elseif queryS = "2" then
				SEOTitle = "111年度大學及四技應試號碼查榜︱入學榜單查詢-1111人力銀行"
				SEOKeywords = "應試號碼查榜、大學放榜、大學申請入學、四技放榜、四技申請入學、放榜"
				SEODescription = "111年度年度(2022)學測、統測、指考放榜交叉查詢，可依姓名、應試碼、考區等不同查榜功能，快速查詢錄取結果！"
				SEOUrl = "https://event.1111.com.tw/event22/22yAdmissionSystem/inquire?years=111&searchType=2"
	...
	[
			{
				...
				"potentialAction": {
						"@type": "SearchAction",
						"target": "https://event.1111.com.tw/event22/22yAdmissionSystem/result?years=111&typeRef=1&schoolType=1&searchType=2&ticketNum={search_term_string}",
